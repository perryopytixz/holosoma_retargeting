...
from holosoma_retargeting.src.interaction_mesh_retargeter_first_order_no_trust_region import (  # noqa: E402
...
DEFAULT_SAVE_DIRS = {
    "robot_only": str(DEFAULT_RESULTS_ROOT / "first_order_no_trust_region" / "{robot}" / "robot_only" / "omomo"),
    "object_interaction": str(DEFAULT_RESULTS_ROOT / "first_order_no_trust_region" / "{robot}" / "object_interaction" / "omomo"),
    "climbing": str(DEFAULT_RESULTS_ROOT / "first_order_no_trust_region" / "{robot}" / "climbing" / "mocap_climb"),
}
