...
from holosoma_retargeting.src.interaction_mesh_retargeter_laplacian_smooth_etasp import (  # noqa: E402
...
DEFAULT_SAVE_DIRS = {
    "robot_only": str(DEFAULT_RESULTS_ROOT / "laplacian_smooth_etasp" / "{robot}" / "robot_only" / "omomo"),
    "object_interaction": str(DEFAULT_RESULTS_ROOT / "laplacian_smooth_etasp" / "{robot}" / "object_interaction" / "omomo"),
    "climbing": str(DEFAULT_RESULTS_ROOT / "laplacian_smooth_etasp" / "{robot}" / "climbing" / "mocap_climb"),
}
