...
from holosoma_retargeting.src.interaction_mesh_retargeter_laplacian_smooth import (  # noqa: E402
...
DEFAULT_SAVE_DIRS = {
    "robot_only": str(DEFAULT_RESULTS_ROOT / "laplacian_smooth" / "{robot}" / "robot_only" / "omomo"),
    "object_interaction": str(DEFAULT_RESULTS_ROOT / "laplacian_smooth" / "{robot}" / "object_interaction" / "omomo"),
    "climbing": str(DEFAULT_RESULTS_ROOT / "laplacian_smooth" / "{robot}" / "climbing" / "mocap_climb"),
}
